...
const Sidebar = () => {
  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      <div className="bg-primary h-[15%] rounded flex flex-col justify-around">
        <div
      ...
      <div className="bg-primary h-[85%] rounded">
        ...
        <div className="p-4 m-2 bg-primary rounded font-semibold flex flex-col items-start gap-1 pl-4 mt-4">
